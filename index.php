    ...
    <section class="sliders">
        ...
        <div class="swiper-container slideshow">
          ...
          <div class="swiper-wrapper">
            ...
            <div class="swiper-slide slide">
                <div class="slide-image" style="background-image: url(img/slider/Accueil2.jpg)"></div>
                <span class="slide-title text-success">salubrité urbaine</span>
              </div>
        
              <div class="swiper-slide slide">
                <div class="slide-image" style="background-image: url(img/slider/Accueil3.jpg)"></div>
                <span class="slide-title text-success">Changement de comportement</span>
              </div>
        
              <div class="swiper-slide slide">
                <div class="slide-image" style="background-image: url(img/slider/présentation.jpg)"></div>
                <span class="slide-title text-success">motivation</span>
              </div>
      ...
      <!-- <div class="wrapper">
        <div class="search-input">
          ...
          <input type="search" placeholder="Type de recherches.." autocomplete="none" id="search" onchange="ouvrirpage()">
          <div class="autocom-box">
          </div>
          <div class="icon"><i class="fa-solid fa-magnifying-glass rec" onclick="ouvrirpage()"></i></div>
        </div>
      </div> -->

      <!-- <div class="container py-5">
        <div class="container py-5 " >
            <input type="text" id="myInput" onkeyup="myFunction()" onchange="ouvrirpage()" placeholder="Rechercher ici...">

            <ul id="myUL">
            <li><a class="cherc" href="présentation.php">Présentation</a></li>
            <li><a class="cherc" href="prestation.php">prestation</a></li>

            <li><a class="cherc" href="contact.php">contact</a></li>
            </ul>
      ...
      #myUL >li .cherc:hover:not(.header) {
...
<!-- <script>
            ...
            <div class="row gx-0 mb-3 mb-lg-0">
                <div class="col-lg-6 my-lg-5 py-lg-5">
                    <div class="about-start  p-5" style="background-color: rgb(118, 189, 12);">
                        <strong class="display-5 mb-4 text-dark">Découvrez l'AFBCI</strong>
                        <p class="text-white">
                            Nous sommes une société engagée dans la gestion des déchets et dans la protection de l'environnement.
                            AFBCI est une société Ivoirienne  qui exercent dans la collecte, le traitement et la valorisation des déchets. Elle assure les services de nettoiement, de collecte et de transfert des déchets ménagers.
                        
                        </p>
                        <a href="" class="btn btn-light rounded-pill py-md-3 px-md-5 mt-4">Découvrir plus</a>
                    </div>
                </div>
            ...
            <div class="row gx-0">
                ...
                <div class="col-lg-6 my-lg-5 py-lg-5">
                    <div class="about-end  p-5" style="background-color: rgb(118, 189, 12);">
                        <strong class="display-5 mb-4 text-dark">Qu'est-ce qu'est-ce que l'AFBCI ?</strong>
                        <p class="text-white">
                            l'association des femmes balayeuse de Côte d'Ivoire est une association qui œuvre pour la salubrité du pays. Nous travaillons dans les communes telles que Cocody,...
                        </p>
                        <!-- <a href="" class="btn btn-light rounded-pill py-md-3 px-md-5 mt-4">Voir Plus</a> -->
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container-fluid  bg-call-to-action py-5" style="margin-top: 90px; background-color: rgb(118, 189, 12);">
        <div class="container py-5">
            <div class="row g-0 justify-content-start">
                <div class="col-lg-6">
                    <strong class="display-5 mb-4 text-dark">Quel intérêt pour vous ? </strong>
                    <p class="fs-4 fw-normal text-white">Œuvrer pour la salubrité totale et intégrale et l’hygiène publique</p>
                    <!-- <a href="contact.php" class="btn btn-light rounded-pill py-md-3 px-md-5 mt-4">Contactez-nous</a> -->
                </div>
            </div>
        </div>
    </div>
    ...
    <!-- <div class="map">
        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d596.5551404870174!2d8.63641253387192!3d49.2942308163552!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x4797beac4fc96d5f%3A0x909f3de31b1264b!2sSAP%20Germany%20SE%20%26%20Co.%20KG%20(WDF21)!5e1!3m2!1sen!2sci!4v1650150313735!5m2!1sen!2sci"  style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
        <iframe src="https://www.google.com/maps/embed?pb=!4v1650150438575!6m8!1m7!1sCAoSLEFGMVFpcE9KRDNSeFhSME1BZG1fRXFWNUY4LVJwTUZiVVIxWkZTQXh5enpZ!2m2!1d49.2944042!2d8.6369159!3f220!4f20!5f0.7820865974627469"  style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
    </div> -->
