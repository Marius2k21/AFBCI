...
<body>
            ...
            <div class="row">
                <div class="col-md-6 text-center text-lg-start mb-2 mb-lg-0">
                    <div class="d-inline-flex align-items-center">
                        <a class="text-dark py-2 pe-3 border-end border-white"  style="display: inline-flex;"><i class="bi bi-telephone text-white me-2"></i>0708637604</a>
                        <a class="text-dark py-2 px-3"  style="display: inline-flex;"><i class="bi bi-envelope text-white me-2" ></i>associationfemmesbalayeusesci@gmail.com </a>
                    </div>
                </div>
    ...
    <nav class="navbar navbar-expand-lg bg-dark navbar-dark shadow-sm px-5 py-3 py-lg-0" >
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto py-0 pe-4 border-end border-5 border-success">
                ...
                <div class="nav-item dropdown">
                    <a href="service.php" class="nav-link dropdown-toggle active" data-bs-toggle="dropdown">Prestations</a>
                    <div class="dropdown-menu m-0">
                        <a href="#Details" class="dropdown-item">Details</a>
                        <a href="#Activités" class="dropdown-item">Activités</a>
                    </div>
                </div>
        ...
        <div class="container py-5">
            <div class="row justify-content-start">
                <div class="col-lg-8 text-center text-lg-start">
                    <h1 class="display-1 text-warning">Nos tâches réalisées</h1>
                    <p class="fs-4 text-warning mb-4">Notre société travaille toujours pour vous, votre environnement, votre santé...
                    </p>
                    <div class="pt-2">
    ...
    <section class="apply-now" style="margin-top: 30px;" id="Details">
        <div class="container">
          <div class="row">
            <div class="col-lg-6 align-self-center">
              <div class="row">
                <div class="col-lg-12">
                  <div class="item">
                    <h3 class="text-warning">Details</h3>
                    <p class="text-warning">En ce qui concerne le néttoyage, Nous balayons dans presque toutes les communes d'Abidjan et aux alentours d'Abidjan. Et ceux, depuis la création de L'AFBCI. 
                        Nous faisons aussi la collete, le balayage et le curage dans les villes telles que Grand-Bassam, Bonoua, Assinie, Khorogho, Yamoussoukro et principalement dans la ville d'Abidjan.
                        </p>
                    <div class="main-button-red">
                      <div class="scroll-to-section"><a href="contact.php">Rejoignez-nous!</a></div>
                  </div>
                  </div>
                </div>
              ...
              <div class="accordions is-first-expanded">
                <article class="accordion">
                    <div class="accordion-head">
                        <span>En ce qui concerne le nettoyage</span>
                        <span class="icon">
                    ...
                    <div class="accordion-body">
                        <div class="content">
                            <p>
                                Nous mettons à votre disposition, des personnes qui travaillent pour la salubrité de notre beaux pays    
                            </p>
                        </div>
                    </div>
                </article>
                <article class="accordion">
                    ...
                    <div class="accordion-body">
                        <div class="content">
                            <p>Nous utilisons comme outils: des tondeuses, balaie à brosse, rateaux...</p>
                        </div>
                    </div>
                </article>
      ...
      <div class="container-fluid py-5" id="Activités" style="margin-top: 250px;">
        <div class="container-fluid py-5">
            <div class="text-center mx-auto mb-5" style="max-width: 500px;">
                <h1 class="display-5">Quelques images</h1>
                <hr class="w-25 mx-auto " style="opacity: 1; background-color: rgb(118, 189, 12);">
            </div>
            <div class="row g-3">
                <div class="col-xl-4 col-lg-6">
                    <div class="blog-item bg-primary">
                        <img class="img-fluid w-100" src="img/act1.jpg" alt="">
                        <div class="d-flex align-items-center">
                            <div class="bg-secondary mt-n4 d-flex flex-column flex-shrink-0 justify-content-center text-center me-4" style="width: 60px; height: 100px;">
                                ...
                                <p class="m-0 text-white">02 mai </p>
                                <small class="text-white">2022</small>
                            </div>
                            <a class="h4 m-0 text-truncate me-4" href="">Je suis HENRY et j'ai des ambitions</a>
                        </div>
                ...
                <div class="col-xl-4 col-lg-6">
                    <div class="blog-item bg-primary">
                        <img class="img-fluid w-100" src="img/act2.jpg" alt="">
                        <div class="d-flex align-items-center">
                            <div class="bg-secondary mt-n4 d-flex flex-column flex-shrink-0 justify-content-center text-center me-4" style="width: 60px; height: 100px;">
                                <i class="fa fa-calendar-alt text-primary mb-2"></i>
                                <p class="m-0 text-white">22 sept</p>
                                <small class="text-white">2021</small>
                            </div>
                            <a class="h4 m-0 text-truncate me-4" href="">Je suis Assistante depuis plusieurs</a>
                        </div>
                ...
                <div class="col-xl-4 col-lg-6">
                    <div class="blog-item bg-primary">
                        <img class="img-fluid w-100" src="img/act3.jpg" alt="">
                        <div class="d-flex align-items-center">
                            <div class="bg-secondary mt-n4 d-flex flex-column flex-shrink-0 justify-content-center text-center me-4" style="width: 60px; height: 100px;">
                                <i class="fa fa-calendar-alt text-primary mb-2"></i>
                                <p class="m-0 text-white">25 oct</p>
                                <small class="text-white">2021</small>
                            </div>
                            <a class="h4 m-0 text-truncate me-4" href="">Je participe à la gestion des</a>
                        </div>
            ...
            <hr class="w-50 mx-auto " style="opacity: 1; background-color: rgb(118, 189, 12);">
    ...
    <div class="container-fluid  bg-call-to-action py-5" style="margin-top: 90px; background-color: rgb(118, 189, 12);">
        <div class="container py-5">
            <div class="row g-0 justify-content-start">
                <div class="col-lg-6">
                    <h1 class="display-5 mb-4">Sggérez-vous d'autres options de formations?</h1>
                    <p class="fs-4 fw-normal">Nous examinons les suggestion de nos visiteurs et organisons des conférence. pour enfin donner une conclusion à l'unanimité de tous</p>
                    <a href="contact.php" class="btn btn-secondary rounded-pill py-md-3 px-md-5 mt-4">Contactez-nous</a>
                </div>
            </div>
        </div>
    </div>
