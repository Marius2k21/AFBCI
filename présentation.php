...
<nav class="navbar navbar-expand-lg bg-dark navbar-dark shadow-sm px-5 py-3 py-lg-0" >
    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
        <div class="navbar-nav ms-auto py-0 pe-4 border-end border-5 border-success">
            ...
            <div class="nav-item dropdown">
                <a href="#" class="nav-link dropdown-toggle active" data-bs-toggle="dropdown">Présentation</a>
                <div class="dropdown-menu m-0">
                    <a href="#Historique" class="dropdown-item">Historique</a>
                    <a href="#Mission" class="dropdown-item">Mission</a>
                    <a href="#Membres" class="dropdown-item">Membres</a>
        ...
        <div class="container py-5">
            <div class="row justify-content-start">
                <div class="col-lg-8 text-center text-lg-start">
                    <strong class="display-1 text-warning">Présentation de l'AFBCI</strong>
                    <p class="fs-4 text-warning mb-4">Vous trouverz ci-dessous, des informations rélatives à notre société
                    </p>
                    <div class="pt-2">
    ...
    <div class="container-fluid py-5"  id="Historique">
        <div class="container-fluid py-5">
            <div class="row gx-0 mb-3 mb-lg-0" >
                <div class="col-lg-6 my-lg-5 py-lg-5">
                    <div class="about-start p-5" style="background-color: rgb(118, 189, 12);">
                        <strong class="display-5 mb-4 text-dark">HISTORIQUE</strong>
                        <p class="text-white">Créer en 2015, l'Association des Femmes Balayeuses de Côte d'Ivoire en abréviation ( AFBCI) regroupe en son sein les femmes Balayeuses qui au quotidien s'attèle a assainir les rues de nos différents quartiers.</p>
                    </div>
                </div>
            ...
            <div class="row gx-0" id="Mission">
                ...
                <div class="col-lg-6 my-lg-5 py-lg-5">
                    <div class="about-end p-5" style="background-color: rgb(118, 189, 12);">
                        <strong class="display-5 mb-4 text-dark">MISSION</strong>
                        <p class="text-white">L' objectif de l'association est de protecter l’environnement et assainir le cadre de vies des populations. 

                            Elle œuvre également pour la promotion de  la dignité humaine à travers  des actions préventives et sécuritaires en proposant, 
                            réalisant et soutenant des projets au sein de l'association  en vue  de pallier à l’indigence des membres afin  de les rendre autonomes.
                            Elle œuvre également:
                            <p class="text-white">
                                -À favoriser la formation des membres en vue de susciter des vocations;  -À renforcer l’efficacité des acteurs de prévention; 
                            </p>
                            <p class="text-white">
                                -Encourager la création d’un cadre permanent en vue de maintenir un périmètre de vie sain.
                            </p>
    ...
    <div class="container-fluid py-5" id="Membres">
        <div class="container py-5">
            <div class="text-center mx-auto mb-5" style="max-width: 500px;">
                <h1 class="display-5">Présentation du bureau exécutif</h1>
                <hr class="w-25 mx-auto "  style="opacity: 1; background-color: rgb(118, 189, 12);">
            </div>
            <div class="row g-3">
                <div class="col-lg-4 col-md-6">
                    <div class="team-item">
                        <img class="img-fluid w-100" src="img/Assiè1.jpg" alt="">
                        <div class="team-text">
                            <div class="team-social">
                                <a  class="btn btn-lg btn-secondary btn-lg-square rounded-circle me-2" href="https://www.instagram.com/mariusalbank/"><i class="fab fa-instagram"></i></a>
                                <a class="btn btn-lg btn-secondary btn-lg-square rounded-circle me-2" href="https://www.facebook.com/"><i class="fab fa-facebook-f"></i></a>
                                <a class="btn btn-lg btn-secondary btn-lg-square rounded-circle me-2" href="https://www.youtube.com/"><i class="fa-brands fa-youtube"></i></a>
                            </div>
                            <div class="mt-auto mb-3">
                                <h4 class="mb-1">Assiè Aya Elise</h4>
                                <span class="text-uppercase">Vice Présidente </span>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="team-item">
                        <img class="img-fluid w-100" src="img/Gayi.jpg"  alt="">
                        <div class="team-text">
                            <div class="team-social">
                                <a class="btn btn-lg btn-secondary btn-lg-square rounded-circle me-2" href="https://twitter.com/AAfbci82469"><i class="fab fa-twitter"></i></a>
                                <a class="btn btn-lg btn-secondary btn-lg-square rounded-circle me-2" href="https://telegram.org/"><i class="fa-brands fa-telegram"></i></a>
                                <a class="btn btn-lg btn-secondary btn-lg-square rounded-circle me-2" href="https://ci.linkedin.com/in/association-afbci-91a699270"><i class="fab fa-linkedin-in"></i></a>
                            </div>
                            <div class="mt-auto mb-3">
                                <h4 class="mb-1">Gayi Grâce Angèle</h4>
                                <span class="text-uppercase">Sécrétaire</span>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="team-item">
                        <img class="img-fluid w-100" src="img/Yao.jpg"  alt="">
                        <div class="team-text">
                            <div class="team-social">
                                <a class="btn btn-lg btn-secondary btn-lg-square rounded-circle me-2" href="https://www.spotify.com/ci-fr/"><i class="fa-brands fa-spotify"></i></a>
                                <a class="btn btn-lg btn-secondary btn-lg-square rounded-circle me-2" href="https://www.facebook.com/"><i class="fab fa-facebook-f"></i></a>
                                <a class="btn btn-lg btn-secondary btn-lg-square rounded-circle me-2" href="https://www.deezer.com/fr/offers"><i class="fa-brands fa-deezer"></i></a>
                            </div>
                            <div class="mt-auto mb-3">
                                <h4 class="mb-1">Yao Patricia Louise</h4>
                                <span class="text-uppercase">Secrétaire adjointe</span>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="container-fluid bg-dark bg-footer text-light py-5">
        <div class="container py-5">
            <div class="row g-5">
                ...
                <div class="col-lg-3 col-md-6">
                    <h4 class="text-white">Bulletin</h4>
                    <hr class="w-25 text-secondary mb-4" style="opacity: 1;">
                    <form action="">
