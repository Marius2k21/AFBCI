                    ...
                    <tbody>
                        <?php while ($membre = $resultat->fetch_assoc()): ?>
                            <tr>
                                ...
                                <td>
                                    <a href="#" name="modifier" class="btn btn-warning btn-sm" data-bs-toggle="modal" data-bs-target="#modal-modifier" data-id="<?= htmlspecialchars($membre['id']); ?>" data-nom="<?= htmlspecialchars($membre['nom']); ?>" data-prenom="<?= htmlspecialchars($membre['prenom']); ?>" data-role="<?= htmlspecialchars($membre['role']); ?>" data-telephone="<?= htmlspecialchars($membre['telephone']); ?>" data-adresse="<?= htmlspecialchars($membre['adresse']); ?>" data-email="<?= htmlspecialchars($membre['email']); ?>">Modifier</a>
